    ...
    <div className="relative w-full py-12 px-4 overflow-hidden">
      <div className="embla overflow-hidden" ref={emblaRef}>
        <div className="embla__container flex">
          {categories.map((category) => (
            <div key={category.id} className="embla__slide flex-[0_0_100%] min-w-0 px-4">
      ...
      <div className="flex justify-center gap-4 mt-12">
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollPrev}
          className="p-4 rounded-full bg-white/10 border border-white/20 hover:bg-white/20 text-white transition-colors shadow-lg"
