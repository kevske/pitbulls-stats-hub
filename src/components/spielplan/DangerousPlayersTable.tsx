                ...
                <table className="w-full border-collapse border border-border min-w-[600px]">
                    <thead>
                        <tr className="bg-muted">
                            ...
                            <th className="border border-border px-4 py-2 text-center">Punkte</th>
                            <th className="border border-border px-4 py-2 text-center">3er</th>
                            <th className="border border-border px-4 py-2 text-center">FW</th>
                            <th className="border border-border px-4 py-2 text-center">Fouls</th>
                        </tr>
                    </thead>
                    <tbody>
                        {players.map((player) => (
