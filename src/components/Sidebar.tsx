  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed z-[70] top-4 left-4 p-2"
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed top-0 left-0 h-screen w-64 bg-background/95 backdrop-blur-md border-r border-border z-60 transform transition-transform duration-300 ease-in-out ${
