...
serve(async (req: Request) => {
    ...
    const corsHeaders = {
        'Access-Control-Allow-Origin': isAllowed ? origin : 'https://kevske.github.io',
    ...
    try {
        const { gameNumber, playerSeconds } = await req.json()
        ...
        // Create admin client with service role key (server-side only) for DB operations
